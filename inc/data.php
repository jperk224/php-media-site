...
$catalog = [];         // Good practice to declare array first as empty and subsequently add to it
$catalog[101] = [
...
// Not using the closing tag is widely accepted and even not allowed in some frameworks (e.g. Zen)
